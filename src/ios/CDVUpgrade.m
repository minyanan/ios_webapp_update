...
- (void)checkUpgrade:(CDVInvokedUrlCommand*)command{
    ...
    NSString *msg2 = [NSString stringWithFormat:@"你当前已是最新版本V%@",localVersion];
    ...
    if ([newVersion floatValue] > [localVersion floatValue])
    {
        ...
        NSLog(@"最新版本不需要更新");
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"版本提示" message:msg2 delegate:nil cancelButtonTitle:@"好的" otherButtonTitles: nil];
        [alert show];
        [alert release];
    }
}
